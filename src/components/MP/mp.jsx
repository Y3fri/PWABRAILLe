...
const MP = () => {
    ...
    const currentMps = filteredMps && filteredMps.slice(indexOfFirstMp, indexOfLastMp);

    const paginate = (pageNumber) => setCurrentPage(pageNumber);

    const pageNumbers = filteredMps ?
        Array.from({ length: Math.ceil(filteredMps.length / MpsPerPage) }, (_, i) => i + 1) :
        [];
    const pages = filteredMps ?
