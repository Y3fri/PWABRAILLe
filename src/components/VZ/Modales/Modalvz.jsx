...
const Modal = ({ closeModal, updateVzList, VzId, vzs }) => {
    ...
    const [currentVz, setCurrentVz] = useState(null);
    ...
    useEffect(() => {
        if (VzId && vzs) {
            const vzToUpdate = vzs.find(vz => vz.vz_id === VzId);
            setCurrentVz(vzToUpdate);
        }
    }, [VzId, vzs]);
    ...
    useEffect(() => {
        if (currentVz) {
            setFormData(prevFormData => ({
                ...prevFormData,
                vz_idestado: currentVz.vz_idestado,
                vz_fecha: currentVz.vz_fecha,
                vz_hora: currentVz.vz_hora,
                vz_unol: currentVz.vz_unol,
                vz_dosl: currentVz.vz_dosl,
                vz_tresl: currentVz.vz_tresl,
                vz_cuatrol: currentVz.vz_cuatrol,
                vz_cincol: currentVz.vz_cincol,                
                vz_unos: currentVz.vz_unos,
                vz_doss: currentVz.vz_doss,
                vz_tress: currentVz.vz_tress,
                vz_cuatros: currentVz.vz_cuatros,
                vz_cincos: currentVz.vz_cincos,                
            }));
        }
    }, [currentVz]);
